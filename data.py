    ...
    "intents": [
        {
            ...
            "responses": ["Hello! How can I help you?", "Hey there!", "Hi! Nice to meet you!"]
        },
        {
            "tag": "goodbye",
        ...
        },
        {
            ...
            "responses": ["I'm NeuralBot, your AI assistant built from scratch!"]
        },
        {
            "tag": "thanks",
            "patterns": ["thanks", "thank you", "that's helpful", "awesome", "great"],
